...
- [Sales Dashboard](/docs/user-guide/sales-dashboard) -- the four sales-activity charts and the Order-distribution card (rep names come straight from the Kontakte file's `Wer` column — Personio is not involved)
