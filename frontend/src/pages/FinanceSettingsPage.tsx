...
import { FinanceTargetsCard } from "@/components/settings/FinanceTargetsCard";
...
const SCOPE_PATH = "/settings/finance";
...
export function FinanceSettingsPage() {
  ...
  const { draft, isDirty, isLoading, isError, isSaving, setField, save, discard } =
    useSettingsDraft({ slice: "finance" });
  ...
  return (
    <div
      data-testid="settings-page-finance"
    ...
    >
      ...
      {!isLoading && !isError && draft && (
        <>
          <FinanceTargetsCard draft={draft} setField={setField} />
