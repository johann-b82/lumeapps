...
export const hrKpiKeys = {
  ...
  schulungUnterlagen: (id: number) => ["hr", "schulungen", "unterlagen", id] as const,
  ...
  einarbeitungKatalog: () => ["hr", "einarbeitung", "katalog"] as const,
  einarbeitungPflicht: () => ["hr", "einarbeitung", "pflicht"] as const,
  ...
  einarbeitungVorgaenge: () => ["hr", "einarbeitung", "vorgaenge"] as const,
  schulungVorgaenge: () => ["hr", "schulungen", "vorgaenge"] as const,
